...
event_time = "2018-12-05T21:52:47.69 | -29.833, +141.526 | 3.49 mb" #339
...
AES=['AES20','AES02','AES07', 'AES08', 'AES03', 'AES16','AES11','AES10','AES04','AES15', 'AES12','AES13']
AEB=['AEB02','AEB20','AEB18', 'AEB11', 'AEB17','AEB16','AEB01','AEB12','AEB13', 'AEB15','AES01','AES09','AEB19'] #,'AEB14']
AEB=['AEB02','AEB20','AEB18', 'AEB11', 'AEB17','AEB16','AEB01','AEB12','AEB13', 'AEB15','AES09','AEB19'] 
# AES=['AES13','AES12','AES10','AES11']
...
for x in AEB:
    ...
    cft = classic_sta_lta_py(trace.data, int(STA * df), int(LTA * df))
    plot_trigger11(trace, cft[0],cft[1],cft[2], On, Off,show=False)
    plt.savefig('{}/dsp_Sta_{}.pdf'.format(Jday,x),bbox_inches='tight', pad_inches=0.2)
    print('Done station:',x)
...
##
cft1 = classic_sta_lta_py(trace.data, int(STA * df), int(LTA * df))
plot_trigger11(trace, cft1[0],cft1[1],cft1[2], On, Off,show=False)
plt.savefig('{}/cl_Sta_OOD.pdf'.format(Jday),bbox_inches='tight', pad_inches=0.2)
print('Done station: OOD')
