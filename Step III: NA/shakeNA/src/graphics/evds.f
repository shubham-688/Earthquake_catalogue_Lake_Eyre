...
c      call edgert(8.0,-5.0)
       read(5,*) ctext
       call typstr(24.5,6.5,0.55,itext,0,40)
       read(5,*) ctext
       call typstr(24.5,5.5,0.5,itext,0,40)
       read(5,*) ctext
       call typstr(24.5,4.,0.5,itext,0,40)
c      
       xpr = 14.0
       ypr = 14.0
       caxt = cos(25.*dgrad)
...
c
       call typned(13. , 0. , 0.7 ,0.6,'latitude [km]',0.0,13)
       call typned( 1. ,12.0, 0.5 ,0.6,'longitude [km]',0.0,14)
       ...
       call typned(-10.0,-0.75, 0.,0.475,'-20',0.0,4)
       call typned( -5.0,-0.75, 0.,0.475,'-10',0.0,3)
       call typned(  5.0,-0.75, 0.,0.475,'10',0.0,2)
       call typned( 10.0,-0.75, 0.,0.475,'20',0.0,3)
       call typned( -1.3,-10., 0.,0.475,'-20',0.0,4)
       call typned( -1.3, -5., 0.,0.475,'-10',0.0,4)
       call typned( -1.3,  5., 0.,0.475,' 10',0.0,4)
       call typned( -1.3, 10., 0.,0.475,' 20',0.0,4)
       call typned( -1.2, 0.,-10.2,0.475,'-20',0.0,4)
       call typned( -1.2, 0.,-5.2,0.475,'-10',0.0,3)
       call typned( -1.2, 0., 4.8,0.475,' 10',0.0,3)
       call typned( -1.2, 0., 9.8,0.475,' 20',0.0,4)
       call typned( 0.5 , 0. ,10.2 ,0.6,'depth [km]',0.0,10)
...
c
       ...
       do 100 k=1,nsol
         ...
         call cszmned(xsa,ysa, 0.,3,0.6,isym,0)
         call plotned(xsa,ysa, 0.,3)
         call cszmned(xsa,ysa,ysb,2,0.6,isym,1)
         call pen(2,0)
         call typned(xsa+0.3,ysa+0.2,ysb+0.1,0.35,modnam,0.0,2)
         call pen(ipen,2)
         ...
         call plot(xt+xsb,yt+0.5,2)
         call pen(2,0)
         call typstr(xt+xsb-0.12,yt-0.55,0.3,modnam,0.0,2)
         call plot(xpr,ypr,3)
100    continue
c
       call Hplots(0,0,8,1)
...
c
        ...
        subroutine cszmned(x,y,z,kp,size,it,nfill)
c-------------------------------------------------------------
