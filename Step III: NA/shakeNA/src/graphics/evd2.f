...
c       call typned(-10.1,-0.3, 0.,0.475,'-100',0.0,4)
c       call typned( -5.1,-0.3, 0.,0.475,'-50',0.0,3)
c       call typned(  5.1,-0.3, 0.,0.475,'50',0.0,2)
c       call typned( 10.1,-0.3, 0.,0.475,'100',0.0,3)
c       call typned( -1.1,-10., 0.,0.475,'-100',0.0,4)
c       call typned( -1.1, -5., 0.,0.475,' -50',0.0,4)
c       call typned( -1.1,  5., 0.,0.475,'  50',0.0,4)
c       call typned( -1.1, 10., 0.,0.475,' 100',0.0,4)
c       call typned( -1.1, 0.,-10.,0.475,'-100',0.0,4)
c       call typned( -1.1, 0., -5.,0.475,'-50',0.0,3)
c       call typned( -1.1, 0.,  5.,0.475,' 50',0.0,3)
c       call typned( -1.1, 0., 10.,0.475,' 100',0.0,4)
       ...
       call typned( -1.1,  5., 0.,0.475,'  10',0.0,4)
       call typned( -1.1, 10., 0.,0.475,' 200',0.0,4)
...
c	
       ...
       call plot(xt+10.,yt    ,3)
       call plot(xt+10.,yt+0.5,2)
       call typstr(xt-10.3,yt+0.6,0.475,'-4',0.0,2)
       call typstr(xt-5.3,yt+0.6,0.475,'-2',0.0,2)
       call typstr(xt-0.2,yt+0.6,0.475,'0',0.0,1)
       call typstr(xt+4.8,yt+0.6,0.475,'2',0.0,1)
       call typstr(xt+9.8,yt+0.6,0.475,'4',0.0,1)
...
c
       ...
       write(6,*) "nsol"
c       asc = 111.19*0.1
c       bsc = 111.19*0.1*cos(olat*dgrad)
       asc = 111.19*0.5
