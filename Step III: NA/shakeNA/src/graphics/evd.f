...
c
       ...
       call typned(-10.1,-0.3, 0.,0.475,'-10',0.0,3)
       call typned( -5.1,-0.3, 0.,0.475,'-5',0.0,2)
       call typned(  5.1,-0.3, 0.,0.475,'5',0.0,1)
       call typned( 10.1,-0.3, 0.,0.475,'10',0.0,2)
       call typned( -1.1,-10., 0.,0.475,'-10',0.0,3)
       call typned( -1.1, -5., 0.,0.475,' -5',0.0,3)
       call typned( -1.1,  5., 0.,0.475,'  5',0.0,3)
       call typned( -1.1, 10., 0.,0.475,' 10',0.0,3)
       call typned( -1.1, 0.,-10.,0.475,'-20',0.0,3)
