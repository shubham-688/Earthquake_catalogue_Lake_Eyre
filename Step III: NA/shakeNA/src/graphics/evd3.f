...
c
       ...
       call typned(-10.1,-0.3, 0.,0.475,'-100',0.0,4)
       call typned( -5.1,-0.3, 0.,0.475,'-50',0.0,3)
       call typned(  5.1,-0.3, 0.,0.475,'50',0.0,2)
       call typned( 10.1,-0.3, 0.,0.475,'100',0.0,3)
       call typned( -1.1,-10., 0.,0.475,'-100',0.0,4)
       call typned( -1.1, -5., 0.,0.475,' -50',0.0,4)
       call typned( -1.1,  5., 0.,0.475,'  50',0.0,4)
       call typned( -1.1, 10., 0.,0.475,' 100',0.0,4)
       call typned( -1.1, 0.,-10.,0.475,'-100',0.0,4)
       call typned( -1.1, 0., -5.,0.475,'-50',0.0,3)
       call typned( -1.1, 0.,  5.,0.475,' 50',0.0,3)
       call typned( -1.1, 0., 10.,0.475,' 100',0.0,4)
