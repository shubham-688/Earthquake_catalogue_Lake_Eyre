c      program remodl
      subroutine remodl(cname)
      save
      include 'limits.inc'
      character*8 code,cname
      character*20 modnam
c     logical ldum
...
c
      ndasr  = 8*(1+2*kb(2))+4
      call dasign(nout,-2,'remodl.tbl',10,ndasr)
...
c
 17   continue
      call retrns(nout)
c
      call assign(nout,-2,'remodl.hed',10)
