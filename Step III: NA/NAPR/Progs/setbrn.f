...
c     read(5,*) ndasr
c
      call assign(nin,-1,'remodl.hed',10)
...
c
      call dasign(nin,-1,'remodl.tbl',10,ndasr)
      nrec=0
      do 1 nph=1,2
      n1=kb(nph)
      ind=0
...
c++ 
      ...
      nc = nb+4
      chmodn = modnam(1:nb)//'.hed'
c*      call assign(nout,-2,modnam(1:nb)//'.hed',nc)
      call assign(nout,-2,chmodn,nc)
      write(6,*) "assign - modnam.hed"
c++ 
     ...
     1 indx,kndx
      ...
      nc = nb+4
c
      call dasign(nout,-2,modnam(1:nb)//'.tbl',nc,nasgr)
      write(6,*) "dasign - modnam.tbl"
      nrec = 0
      do 16 nph=1,2
      m1=mt(nph)
      n1=ku(nph)
