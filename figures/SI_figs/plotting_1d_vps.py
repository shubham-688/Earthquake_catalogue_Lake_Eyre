...
fig = plt.figure(figsize=(2,6),dpi=250)
...
plt.plot(LA_Vp[:,1],LA_Vp[:,0], 'indianred',linestyle=':')
...
plt.plot(ak135Vp[:,1],ak135Vp[:,0], 'seagreen',linestyle=':')
...
plt.xticks(np.arange(1.65, 1.95, .1))
plt.yticks(np.arange(-10, 500, 80))
plt.ylim((47,0))
plt.xlim((1.65,1.85))
# plt.legend(fontsize="8")
plt.savefig('1dmodel_crust_vps.png',bbox_inches='tight', pad_inches=0.1)
plt.show()
